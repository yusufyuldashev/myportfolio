<template>
  <section id="section6">
    <div id="container">
      ...
      <p class="contact__title__line"></p>
...
#section6 {
  ...
  //   180deg,
  //   rgba(187, 133, 255, 0.166) -8.54%,
  //   rgba(255, 244, 251, 0.2) 100%
  // );
